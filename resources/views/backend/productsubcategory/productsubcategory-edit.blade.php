...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2 class="mt-3 mb-2">Edit Product Sub Category</h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{route('productsubcategory.update',$subcategory->id)}}" method="post"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="subcat_name"
                                    placeholder="Enter Product Category Name" value="{{$subcategory->name}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="subcat_id">
                                    ...
                                    @foreach ($cat as $item)
                                    <option value="{{$item->id}}" {{ $item->id == $subcategory->product_category_id ?
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="{{asset('storage/subcategory_images/'.$subcategory->subcategory_image) }}"
                                    class="rounded img-thumbnail shadow-sm" alt="subcat_img" />
