...
@section('title', 'Technical CreatePage')
@section('content')

<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2 class="mt-3 mb-2">Create Technical Support</h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{route('techsupport.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-10">
                                <div class="summernote">
                                    <textarea id="summernote" class="form-control mt-2" cols="20" rows="5"
                                        placeholder="Enter Body" name="techsupp_des" required></textarea>
