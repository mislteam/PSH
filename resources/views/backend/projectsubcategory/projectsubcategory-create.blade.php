...
@section('title', 'Project-sub-category Create-Page')
@section('content')
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2 class="mt-3 mb-2">Create Project Sub Category</h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{route('project-sub-category.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
