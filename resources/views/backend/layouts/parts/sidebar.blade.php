    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            {{-- <li class="{{ url()->current() == url('/admin/products/product') ? 'active' : '' }}">
                <a href="{{ route('product.index') }}"><i class="fa fa-th-large"></i> <span
                ...
                <ul class="nav nav-second-level collapse">                        
                    ...
                    <li class="{{ url()->current() == url('/admin/products/product') ? 'active' : '' }}">
                        <a href="{{ route('product.index') }}"><span
                                class="nav-label">All Products</span></a>
                    </li>
                    <li class="{{ url()->current() == url('/admin/products/Category') ? 'active' : '' }}">
                        <a href="{{ route('product.index') }}"> <span
                                class="nav-label">Products Category</span></a>
                    </li><li class="{{ url()->current() == url('/admin/products/Category') ? 'active' : '' }}">
                        <a href="{{ route('product.index') }}"> <span
                                class="nav-label">Products Sub Category</span></a>
                    </li><li class="{{ url()->current() == url('/admin/products/Brands') ? 'active' : '' }}">
                        <a href="{{ route('product.index') }}"> <span
                                class="nav-label">Products Brands</span></a>
                    </li>
                    <li class="{{ url()->current() == url('/admin/products/Warranty') ? 'active' : '' }}">
                        <a href="{{ route('product.index') }}"> <span
                                class="nav-label">Products Warranty</span></a>
                    </li>
                    <li class="{{ url()->current() == url('/admin/products/User') ? 'active' : '' }}">
                        <a href="{{ route('product.index') }}"> <span
                                class="nav-label">User Support</span></a>
                    </li>
                    <li class="{{ url()->current() == url('/admin/products/Technical') ? 'active' : '' }}">
                        <a href="{{ route('product.index') }}"> <span
                                class="nav-label">Technical Support</span></a>
                    </li>
                </ul>
            </li>
            @can('view customers')
            <li class="{{request()->is('admin/customer*') ? 'active' : ''}}">
                <a href="{{ route('customer.index') }}"><i class="fa fa-users"></i> <span class="nav-label">All Users</span></a>
            @endcan
            @can('view admin')
            <li class="{{request()->is('admin/user*') ? 'active' : ''}}">
                <a href="{{ route('userIndex') }}"><i class="fa fa-user-secret" aria-hidden="true"></i> <span class="nav-label">All Admin</span></a>
            @endcan
