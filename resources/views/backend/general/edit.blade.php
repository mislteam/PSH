...
@section('content')
    ...
    <div class="col-md-2 mt-4 text-right">
        <a href="{{ route('generalIndex') }}" class="btn bg-custom btn-sm"> Go Back </a>
    </div>
</div>
                       ...
                       <div class="form-group  row">
                           <div class="col-sm-12">
                               ...
                               <?php }elseif($data->type == 'file'){ ?>
                                   ...
                                   <img src="{{asset(asset('image/logo/'.generalSetting('qr-logo')))}}" 
                                   class="img-fluid w-25 mb-2" id="preview_image_before_upload">  
                                   @else 
                                    <img src="{{asset('image/logo/'.generalSetting('logo'))}}" 
                                    class="img-fluid w-25 mb-2" id="preview_image_before_upload">
                                   @endif
