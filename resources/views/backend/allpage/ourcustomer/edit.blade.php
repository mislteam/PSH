        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{route('ourcustomer.update',$ourcustomer->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><strong>Title</strong></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" value="{{$ourcustomer->title}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="link" value="{{$ourcustomer->link}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="{{asset('storage/customer_img/'. $ourcustomer->customer_img) }}"
