...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2 class="mt-3 mb-2">Edit Home page</h2>
        <ol class="breadcrumb">
                ...
                <div class="ibox-content">
                    <form action="{{route('home.update',$home->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" value="{{$home->title}}" placeholder="Enter title" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><strong>Sub Title</strong></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="sub_title" value="{{$home->sub_title}}" placeholder="Enter Sub title"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="summernote" class="form-control mt-2" cols="20" rows="2"
                                    placeholder="Enter Description" name="description" required>{{$home->description}}"</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><strong>Background Image</strong></label>
                            <div class="col-sm-10">
                                <img src="{{asset('storage/home-bg-image/'. $home->bg_image) }}"
                                class="rounded img-thumbnail shadow-sm w-25 h-auto" alt="brand_img"  />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="btn_text" value="{{$home->link}}" placeholder="Enter Button Text"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="link" value="{{$home->link}}" placeholder="Enter URL Link"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row">
