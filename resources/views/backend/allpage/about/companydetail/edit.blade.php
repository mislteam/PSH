...
@section('title', 'Company Detail Edit-Page')
@section('content')
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2 class="mt-3 mb-2">Edit Company Detail page</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="dashboard.html">Home</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Edit Company Detail page</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-8">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{route('about.companydetailupdate',$companydetail->id)}}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><strong>Title</strong></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" value="{{$companydetail->title}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="value" value="{{$companydetail->value}}"
                                    placeholder="Enter title" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="summernote" class="form-control mt-2" cols="20" rows="2"
                                    ...
                                    >{{$companydetail->description}}"</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
