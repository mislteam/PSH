...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        <h2 class="mt-3 mb-2">Edit Product Type</h2>
        <ol class="breadcrumb">
                ...
                <div class="ibox-content">
                    <form action="{{route('producttype.update',$productType->id)}}" method="post"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><strong>Product Type Name:</strong></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name"
                                    placeholder="Enter Product Category Name" value="{{$productType->name}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
