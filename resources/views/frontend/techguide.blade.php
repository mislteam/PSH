...
<div role="main" class="main">
            ...
            <div class="row">
                <div class="col text-center">
                    <ul class="breadcrumb d-flex justify-content-center text-4-5 font-weight-medium mb-2">
                        ...
                        <li class="text-color-primary active">Technical Supports</li>
                    </ul>
                    <h1 class="text-color-light font-weight-bold text-10">Technical Supports</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container py-5 my-4">
        <div class="row">
            <div class="col text-center">
                <div class="appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="0">
                    ...
                    <h2 class="text-color-dark font-weight-extra-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200"><em>Technical Support</em></h2>
        ...
        <div class="row">
            <div class="col text-center">
                <form class="contact-form custom-form-style-1 appear-animation form-inline" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="800" action="" method="POST">
                    ...
                    <div class="row d-flex mb-2">
                        <div class="form-group col mb-3">
                            <input type="text" value="" data-msg-required="Enter Products Name" maxlength="100" class="form-control border-radius-0" name="name" id="name" required placeholder="Enter Product Name">
                        </div>
                        <div class="form-group col-lg-2 mb-0">
                            <button type="submit" class="btn btn-primary font-weight-bold btn-px-5 btn-py-3 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="350" data-loading-text="Loading...">Search</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="row row-gutter-sm py-2">
            ...
            <div class="d-flex align-items-center col-md-6 col-lg-4 mb-4 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="200">
                <a href="#" class="text-decoration-none">
                    <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                        ...
                        <div class="card-body text-center">
                            <h2 class="card-title alternative-font-4 text-color-dark font-weight-semibold line-height-1 text-5 mb-1 line-height-4">{{$item->name}}</h2>
                            <a href="{{route('techguidedetail', $item->id)}}">
