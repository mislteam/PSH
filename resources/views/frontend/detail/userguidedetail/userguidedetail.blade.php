            ...
            <div class="row">
                <div class="col text-center">
                    <ul class="breadcrumb d-flex justify-content-center text-4-5 font-weight-medium mb-2">
                        ...
                        <li class="text-color-primary active">User Support</li>
                    </ul>
        ...
        <div class="container">
            <div class="row pb-4">
                <div class="col mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorterPlus"
                    ...
                    <h2 class="text-color-dark font-weight-bold text-10 mb-2"><em>{{$userguidedetail->name}}</em></h2>
                    <ul
                    ...
                    <p class="mb-0">{!!$userguidedetail->description!!}</p>
                    {{-- <div class="row">
