        ...
        <div class="container py-4">
            <div class="row">
                <div class="col text-center">
                    ...
                    <h1 class="text-color-light font-weight-bold text-10">Truck Scale</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col text-center">
                <div class="appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="0">
                    ...
                    <h2 class="text-color-dark font-weight-extra-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200"><em>Truck Scale</em></h2>
            ...
            <div class="col-lg-4 d-flex align-items-stretch">
                <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1 appear-animation animated fadeInUp appear-animation-visible" data-appear-animation="blurIn" data-appear-animation-delay="0" style="animation-delay: 0ms;">
                    <div class="card-body text-center px-4 py-4">
                        <img class="img-fluid card-img-top border mb-4" src="{{asset('storage/brand_image/'.$item->brand_image) }}" alt="" />
